...
import com.ogif.kotae.editor.StrikethroughEditHandler;
...
//          Debug.e("clicked: %s", link);
        ...
        editText = binding.etQuestionContent;
...
//      Debug.i("text: '%s', %d-%d (%d)", text.subSequence(start, end), start, end, text.length());
    ...
    private void initBottomBar() {
        ...
        Button bold = binding.btnBold;
        Button italic = binding.btnItalic;
        Button strike = binding.btnStrike;
        Button quote = binding.btnQuote;
        Button code = binding.btnCode;
